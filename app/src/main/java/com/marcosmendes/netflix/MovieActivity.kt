...
import com.marcosmendes.netflix.util.DownloadImageTask
import com.marcosmendes.netflix.util.MovieTask
...
class MovieActivity : AppCompatActivity(), MovieTask.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar: androidx.appcompat.widget.Toolbar = findViewById(R.id.movie_toolbar)
        ...
        val url = "https://api.tiagoaguiar.co/netflixapp/movie/$id?apiKey=2052d628-f0c4-46c2-b4d3-f8d43d7dd904"
